...
//        item.setSeries(null);
        try {
            Method setSeries = XYChart.Data.class.getDeclaredMethod("setSeries");
            setSeries.setAccessible(true);
            setSeries.invoke(item, new Object[]{null});
...
//        }
    ...
    @Override protected void layoutPlotChildren() {
        ...
        double barWidth = (avilableBarSpace / seriesSize) - getBarGap();
...
//    }
    ...
    private void updateDefaultColorIndex(final Series<X,Y> series) {
        ...
        Map<Series, Integer> seriesColorMapValue = null;
        try {
            Field seriesColorMap = XYChart.class.getDeclaredField("seriesColorMap");
            seriesColorMap.setAccessible(true);
            seriesColorMapValue = (Map<Series, Integer>) seriesColorMap.get(this);
        ...
        BitSet colorBitsValue = null;
        try {
            Field colorBits = XYChart.class.getDeclaredField("colorBits");
            colorBits.setAccessible(true);
            colorBitsValue = (BitSet) colorBits.get(this);
        ...
        // DEFAULT_COLOR
        String DEFAULT_COLOR_VALUE = null;
        try {
            Field DEFAULT_COLOR = XYChart.class.getDeclaredField("DEFAULT_COLOR");
            DEFAULT_COLOR.setAccessible(true);
            DEFAULT_COLOR_VALUE = (String) DEFAULT_COLOR.get(null);
