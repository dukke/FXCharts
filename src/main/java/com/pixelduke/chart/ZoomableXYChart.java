...
public final class ZoomableXYChart<X, Y> implements IChart<X, Y> {
    ...
    private void setupZoom() {
        ...
        chart.setOnMousePressed((MouseEvent mouseEvent) -> {
        ...
        chart.setOnMouseDragged((MouseEvent mouseEvent) -> {
        ...
        chart.setOnMouseReleased((MouseEvent mouseEvent) -> {
            if (mouseModeProperty.get() != MouseMode.ZOOM) {
                return;
            }
